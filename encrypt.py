# -*- coding: utf-8 -*-
"""
Created on Fri Jul 23 00:12:13 2021
...
main_title = Label(window, text="File Encryptor and Decryptor", width=100, height=2, fg="white", bg="greenyellow",font =("",30))
passwd = StringVar()

submit_para_en = partial(encrypt_file, passwd)
submit_para_de = partial(decrypt_file, passwd)

credit = Label(window,text = "Developed by ABRACADABRA", bg="bisque",height=2,  fg = "black" , font =("",15))
label_file_explorer = Label(window, text="File Name : ", width=100, height=2, fg="white", bg="yellowgreen",font =("",20))
pass_label = Label(window, text="Password for encryption/decryption : ", width=100, height=2, fg="black", bg="bisque",font =("",20))
temp_label = Label(window, text="", height=3, bg="bisque")
...
status_label = Label(window, text="", width=100, height=4, fg="greenyellow", bg="bisque",font =("",17))
